...
// REST URL
$service_url = 'https://ct.soa-gw.canadapost.ca/rs/' . $mailedBy . '/' . $mobo . '/shipment/843461694614233722/details';
...
if (!$xml) {
	...
	if ($xml->{'shipment-details'} ) {
		$shipmentDetails = $xml->{'shipment-details'}->children('http://www.canadapost.ca/ws/shipment-v8');
