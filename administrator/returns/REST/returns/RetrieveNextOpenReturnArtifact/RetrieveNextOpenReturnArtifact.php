...
// REST URI
$service_url = 'https://ct.soa-gw.canadapost.ca/rs/' . $mailedBy . '/' . $mobo . '/openreturn/349641323786705649/artifact';

$curl = curl_init($service_url); // Create REST Request
curl_setopt($curl, CURLOPT_SSL_VERIFYPEER, true);
curl_setopt($curl, CURLOPT_SSL_VERIFYHOST, 2); 
curl_setopt($curl, CURLOPT_CAINFO, realpath() . '/../../../third-party/cert/cacert.pem'); // Mozilla cacerts
...
if ( strpos($contentType, 'application/pdf' ) !== FALSE ) {
	...
	$fileName = 'openReturnArtifact.pdf';
